...
ESTRUCTURA DE SALIDA (plan_document):
{
  ...
  "estrategia_comunitaria": "USA LAS FICHAS de <ficha_de_la_paz> (son las asignadas a esta planeación — NUNCA inventes otra actividad ni uses otra ficha). La actividad CAMBIA cada semana: escribe un bloque por cada semana listada ahí, en orden. Cada bloque abre con un encabezado en negritas '**Semana N**' seguido EXACTAMENTE de: 'Fichero de la Paz. Ficha número N \\"Nombre de la ficha\\".' y después la actividad de ESA ficha adaptada al grupo, paso a paso (8-12 pasos numerados): planteamiento, desarrollo, cierre con reflexión. Si <ficha_de_la_paz> trae una sola ficha, omite el encabezado de semana. NUNCA repitas la actividad de una semana en otra.",
  ...
  "ajustes_razonables": "SIEMPRE con esta estructura, haya o no alumnos con NEE (si el formato de la maestra pide otros sub-encabezados para ajustes_razonables, usa ESOS con la misma mecánica): una viñeta inicial que diga a quién van dirigidos y qué áreas se apoyan, y después estos 5 sub-encabezados con '## ', cada uno con 2-5 viñetas concretas:\\n## 1. Ubicación del Aula\\n## 2. Ajustes en los Tiempos\\n## 3. Consignas Accesibles y Claras\\n## 4. Estrategias para Mantener la Atención\\n## 5. Estrategias para la Ejecución y Autorregulación\\nCon alumnos NEE: usa SIEMPRE su etiqueta anónima (Alumno A, Alumno B…), NUNCA el nombre real, y haz las viñetas específicas para cada uno. Sin alumnos NEE: la viñeta inicial indica que el grupo no tiene NEE identificadas y que estos ajustes son de diseño universal para TODO el grupo mientras se observa para detectar necesidades de apoyo — las 5 categorías se llenan igual, con estrategias concretas aplicadas al grupo. NUNCA respondas solo con un párrafo diciendo que no hay alumnos con NEE.",
  ...
  "proyecto": "el CORAZÓN del documento, desarrollado a profundidad. OBLIGATORIO: DEBE contener TODOS los momentos de la metodología como encabezados en **negritas**, y bajo CADA momento el contenido va SIEMPRE en viñetas \"- \" (mínimo 4-8 viñetas por momento, una idea por viñeta) — un momento escrito como párrafo corrido, o un proyecto sin encabezados de momentos, es un ERROR GRAVE. Para metodología Proyecto: **Punto de Partida** (situación detonadora, video/material, preguntas a los niños — en viñetas), **Planeación** (4-6 viñetas de lo que reconocerán/realizarán; incluye la construcción del **friso** —mural de planeación con los niños donde se ven las acciones del mes—), **A trabajar** (actividades concretas y variadas, incluyendo libros Richmond con formato 'STUDENT BOOK páginas X a Y', 'ACTIVITY BOOK páginas X', 'ASSESSMENT: Unit N páginas X', talleres, investigaciones, productos), **Comunicamos Nuestros Logros** (cómo presentan/comparten el producto final), **Reflexión sobre el aprendizaje** (cómo cierran y metacognición). Si <estructura_proyecto> especifica otros momentos, usa ESOS. PROHIBIDO desarrollar aquí las actividades del día de Letters ni del día de Números: cada uno tiene su PROPIA sub-planeación y repetirlas aquí duplica el documento. En 'A trabajar' cubre SOLO los días de proyecto — si necesitas nombrar los otros dos días, una línea de referencia basta ('ese día corresponde a Letters, ver su planeación'), nunca sus actividades, hojas de trabajo ni juegos.",
  "cronograma": {
...
- UNA IDEA = UNA VIÑETA: dentro de "proyecto", "desarrollo_taller" y las estructuras didácticas, TODO el contenido de cada momento va en viñetas que empiezan con "- ". Cada punto y aparte (cada idea, actividad o tema distinto) es su PROPIA viñeta. PROHIBIDO encadenar ideas distintas en un párrafo corrido o separarlas solo con punto y seguido.
- Usa viñetas ("- ") o numeración en el resto de las secciones donde aplique
